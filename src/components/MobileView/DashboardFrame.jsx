...
export const DashboardFrame = () => {
  ...
  return (
    <div className="w-full h-auto flex flex-col items-start gap-6 p-0">
...
const FrameItem = ({ item }) => {
  ...
  return (
    <div className="w-full h-auto flex flex-auto flex-row  p-6 gap-4 bg-white shadow-md rounded-xl justify-between">
      ...
      <div
        className="w-[32px]  flex flex-auto items-center justify-center text-2xl"
