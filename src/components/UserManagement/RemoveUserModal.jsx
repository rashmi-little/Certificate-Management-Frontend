...
export default function RemoveUserModal({ open, setOpenModal }) {
                ...
                <Fade in={open}>
                    ...
                    sx={{
                        ...
                        <div className='h-[23px] w-full flex justify-between'>
                            <h1 className='font-roboto font-semibold text-xl leading-[100%] tracking-[0%] text-[#394555]'>Remove user?</h1>
                        ...
                        <div className='h-[38px] w-full flex flex-col gap-6'>
                            <p className='font-roboto font-normal text-base color-[#757D8A]'>Are you sure you want to delete this user? This action cannot be undone.</p>
                        </div>
